...
pluralCaseList.push( {plural: "drives/driveStores", pascal: "DriveDriveStore"} )

pluralCaseList.push( {plural: "indexers/indexerStores", pascal: "IndexerIndexerStore"} )

pluralCaseList.push( {plural: "vedioProcessings/videoStores", pascal: "VedioProcessingVideoStore"} )

pluralCaseList.push( {plural: "notifications/notificationStores", pascal: "NotificationNotificationStore"} )
