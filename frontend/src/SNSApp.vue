            ...
            <v-navigation-drawer app clipped flat v-model="sideBar">
                <v-list>
                    ...
                    <v-list-item
                        class="px-2"
                        key="videoStores"
                        to="/vedioProcessings/videoStores"
                        @click="changeUrl()"
                        color="primary"
                        style="font-weight:700;"
                    >
                    ...
                    <v-list-item
                        class="px-2"
                        key="notificationStores"
                        to="/notifications/notificationStores"
                        @click="changeUrl()"
                        color="primary"
                        style="font-weight:700;"
                    >
    ...
    data: () => ({
        ...
        aggregate: [
            ...
            { 
                ...
                description: '', 
                key: 'videoStores', 
                route: '/vedioProcessings/videoStores',
                ImageUrl: '',
            },
            { 
                ...
                description: '', 
                key: 'notificationStores', 
                route: '/notifications/notificationStores',
                ImageUrl: '',
            },
